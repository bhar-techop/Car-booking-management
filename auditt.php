                              ...
                              <div class="row"> 
                                ...
                                <div class="col-sm-4">
                                   <?php
                                    ...
                                    {
                                    echo '<a href="booking.php" class="btn1"><button class="btn">BOOK CAR</button></a>';
                                   
                                }else
                                    {
                                      echo '<a href="login.php" class="btn1"><button class="btn">BOOK CAR</button></a>';  
                                    }
                                    ?>
                                </div>
                                <button class="btn">BOOK CAR</button>
                                <div class="col-sm-4">       
                                </div>
